 ...
 * 
 */
@WebServiceClient(name = "KPSPublic", targetNamespace = "http://tckimlik.nvi.gov.tr/WS", wsdlLocation = "file:/KPSPublic.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Users/eemrond/Desktop/KPSPublic.wsdl");
